...
namespace PokerEngine::Games {
    ...
    int SevenCardStud::getMaxBettingRounds() const {
        return 4;
    }  // 3rd, 4th, 5th, 6th, 7th street
    bool SevenCardStud::hasCommunityCards() const { return false; }

    int SevenCardStud::getStartingHandSize() const { return 3; }

    void SevenCardStud::postMandatoryBets(std::vector<Player>& players,
                                          int& pot,
    ...
    void SevenCardStud::dealStreet(std::vector<Player>& players,
    ...
    int SevenCardStud::evaluateHand(const Hand& holeCards,
    ...
    int PokerEngine::Games::SevenCardStud::evaluateHandFast(
