#include "../../include/BotProfiles/BaselineStrategies.hpp"
...
namespace PokerEngine {
    namespace AI {
        ...
        ActionProbs BalancedAction::getProbs(double equity,
        ...
        ActionProbs PolarizedAction::getProbs(double equity,
                                              std::mt19937& rng) const {
            if (equity >= 0.8) {
        ...
        ActionProbs LAGAction::getProbs(double equity,
                                        std::mt19937& rng) const {
            std::uniform_real_distribution<double> dist(0.0, 1.0);
        ...
        ActionProbs NitAction::getProbs(double equity,
                                        std::mt19937& rng) const {
            std::uniform_real_distribution<double> dist(0.0, 1.0);
        ...
        ActionProbs ManiacAction::getProbs(double equity,
                                           std::mt19937& rng) const {
            std::uniform_real_distribution<double> dist(0.0, 1.0);
            if (dist(rng) < 0.333) {
        ...
        ActionProbs StationAction::getProbs(double equity,
                                            std::mt19937& rng) const {
            if (equity >= 0.95) {
        ...
        ActionProbs ABCAction::getProbs(double equity,
                                        std::mt19937& rng) const {
            if (equity < 0.4) {
        ...
        double GaussianSizing::getSizing(double equity,
                                         std::mt19937& rng) const {
            std::normal_distribution<double> dist(0.75, 0.2);
            return std::max(0.1, dist(rng));
        }

        double UniformSizing::getSizing(double equity,
                                        std::mt19937& rng) const {
            std::uniform_real_distribution<double> dist(0.1, 2.0);
            return dist(rng);
        }

        double BimodalSizing::getSizing(double equity,
                                        std::mt19937& rng) const {
            std::uniform_real_distribution<double> dist(0.0, 1.0);
        ...
        double ExponentialSizing::getSizing(double equity,
                                            std::mt19937& rng) const {
        ...
        double GradientSizing::getSizing(double equity,
                                         std::mt19937& rng) const {
            double size = 0.5 + equity * 1.0;
            return std::max(0.1, size);
        }

        double ReverseSizing::getSizing(double equity,
                                        std::mt19937& rng) const {
